...
import { useCasePrediction } from './useCasePrediction';
...
describe('useCasePrediction', () => {
  it('should call getCasePrediction when mutate is called', async () => {
    // Arrange
    ...
    // Mock implementation
    (getCasePrediction as ReturnType<typeof vi.fn>).mockResolvedValue(mockResponse);
    
    // Act
    const { result } = renderHook(() => useCasePrediction(), {
    ...
    expect(getCasePrediction).toHaveBeenCalledWith(mockRequest);
  ...
  it('should handle error when API call fails', async () => {
    ...
    (getCasePrediction as ReturnType<typeof vi.fn>).mockRejectedValue(mockError);
  ...
  it('should execute onSuccess callback if provided', async () => {
    ...
    // Act
    const { result } = renderHook(() => useCasePrediction({ onSuccess }), {
      wrapper: createWrapper()
    });
