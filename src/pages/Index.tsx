        ...
        <section className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            <h1 className="font-heading font-bold text-heading-1 mb-6">
              <span className="bg-clip-text text-transparent bg-brand-gradient">AI</span>{" "}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={feature.title} className="p-6 rounded-lg border border-white/10 bg-surface hover:border-brand-gradient-end/50 transition-colors">
